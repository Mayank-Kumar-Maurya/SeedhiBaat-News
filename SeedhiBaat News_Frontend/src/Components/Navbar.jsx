...
function Navbar() {
  ...
  let {airesponse} = useContext(ServerContext)

  return (
    <>
      <nav className="navbar navbar-expand-lg bg-body-tertiary mb-2">
  <div className="container-fluid">
    <Link className="navbar-brand" to="/" style={{color: "Blue"}}><i className="fa-regular fa-newspaper fa-fade"></i> Seedhi B<span style={{color: "pink"}}>Aa</span>t</Link>
